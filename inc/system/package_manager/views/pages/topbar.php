...
if($team->owner == $uid){
    ...
    $package_id = $this->main_model->get("package", "sp_users", " id = '{$team->owner}' ");
}

$package_name_arr = $this->main_model->fetch("name", "sp_package_manager", "id = {$package_id}");
$package_name = $package_name_arr[0]->name;
?>
