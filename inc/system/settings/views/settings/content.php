<form>
    ...
    <div class="m-b-40">
        ...
        <div class="form-group">
            ...
            <input type="text" placeholder="Your *WaziPer OTP* is:" class="form-control" id="otpmessages" name="otpmessages" value="<?php _e( get_option('otpmessages', 'Your *WaziPer OTP* is:') )?>">
        </div>
    </div>
