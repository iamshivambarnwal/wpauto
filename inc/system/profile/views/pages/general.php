            ...
            <div class="card-body">
                <form class="actionForm" action="<?php _e( get_module_url("ajax_account") )?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="phone_number" name="phone_number" <?php _e( !get_option('signup_change_email_status', 0)?"disabled":"" )?> value="<?php _e($result->phone_number)?>">
                    </div>
                    <div class="form-group">
