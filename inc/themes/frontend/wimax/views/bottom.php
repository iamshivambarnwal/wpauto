   ...
   <!-- EXTERNAL SCRIPTS
		============================================= -->	
		<script src="<?php _e( get_theme_frontend_url('assets/js/jquery-3.6.0.min.js'))?>"></script>
		<script src="<?php _e( get_theme_frontend_url('assets/js/bootstrap.min.js'))?>"></script>	
		<script src="<?php _e( get_theme_frontend_url('assets/js/modernizr.custom.js'))?>"></script>
		<script src="<?php _e( get_theme_frontend_url('assets/js/jquery.easing.js'))?>"></script>
		<script src="<?php _e( get_theme_frontend_url('assets/js/jquery.appear.js'))?>"></script>
		<script src="<?php _e( get_theme_frontend_url('assets/js/jquery.scrollto.js'))?>"></script>	
		<script src="<?php _e( get_theme_frontend_url('assets/js/menu.js'))?>"></script>
		<script src="<?php _e( get_theme_frontend_url('assets/js/owl.carousel.min.js'))?>"></script>
		<script src="<?php _e( get_theme_frontend_url('assets/js/jquery.magnific-popup.min.js'))?>"></script>
		<script src="<?php _e( get_theme_frontend_url('assets/js/quick-form.js'))?>"></script>	
		<script src="<?php _e( get_theme_frontend_url('assets/js/request-form.js'))?>"></script>	
		<script src="<?php _e( get_theme_frontend_url('assets/js/jquery.validate.min.js'))?>"></script>
		<script src="<?php _e( get_theme_frontend_url('assets/js/jquery.ajaxchimp.min.js'))?>"></script>	
		<script src="<?php _e( get_theme_frontend_url('assets/js/wow.js'))?>"></script>
		<?php include 'wimaax.php';?>
		<!-- Custom Script -->		
		<script src="<?php _e( get_theme_frontend_url('assets/js/custom.js'))?>"></script>
  </body>
</html>