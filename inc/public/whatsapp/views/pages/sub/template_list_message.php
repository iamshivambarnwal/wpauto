                ...
                <div class="card mb-4 box-shadow">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-center align-items-center text-center">
                            <div class="btn-group">
                                <a href="<?php _e( get_module_url("get/template_list_message_update/".$value->ids) )?>" class="wa-action-item wa-open-content btn btn-sm btn-label-info" data-result-content="wa-content"><i class="ri-edit-line" title="<?php _e("Edit")?>"></i></a>
